...
import de.flammenfuchs.utilities.bungeecord.common.commands.ArgsUtil;
import de.flammenfuchs.utilities.bungeecord.common.commands.ConsoleCommand;
import de.flammenfuchs.utilities.bungeecord.common.commands.ConsoleSubCommand;
...
public class LanguageCommand extends ConsoleCommand {
    public LanguageCommand() {
        super("language", "minecraftutilities.language", "lang");
    ...
    public void onCommand(CommandSender sender, String[] args) {
        sender.sendMessage(HelpPattern.build(this, ChatColor.AQUA));
    }
